...
| Oct 27 | M  | supervised learning (logistic regression + naive bayes as examples) ; discriminative vs generative classification ;deriving a loss function from a likelihood ; learning with class imbalances ; preventing data leakage        | Natalie       |
